...
export default class English extends React.Component {
    render() {
        return <Layout title="Privacy Policy (valid from 24th May 2018 - 14th April 2019)" noCopy>
            <div className="uk-alert-success" uk-alert="">
                <a className="uk-alert-close" uk-close=""></a>
                <p>
                    This policy came into effect on the 24th May 2018 and was replaced by a new privacy policy on 15th April 2019. 
                    Please see <Link href="/documents/privacy/2019/"><a>the privacy policy valid after this date</a></Link> and <Link href="/documents/privacy/2017/"><a>the privacy policy valid before this date</a></Link>. 
                </p>
            </div>
            ...
            <ul>
                ...
                <li>The status of access (file transfered, file not found)</li>
            ...
            <p>
                Only the Corporate Relations and Talent Management Department, the Executive Office, the Managing Director&rsquo;s Office, SBU1, SBU2, SBU4 Business Solutions and the Dean&rsquo;s Office at Jacobs University Bremen have access to your data. 
                You are explicitly informed that your data is not intended for use by the Student Financial Services department. 
                Neither JUBAA nor Jacobs University Bremen will disclose your data to any other third parties. 
            </p>

            <h3>Data Transfer to Stripe Inc.</h3>
            <p>
                To enable processing of membership fess, we transfer a very limited set of information to our payment provider Stripe, Inc. 
                This information is only used to process membership fees.
            </p>
            ...
            <ul>
                ...
                <li>your existing email address, so that Google can send you an email with access details to your new E-Mail account</li>
                <li>your graduation year(s) and major(s) so that we can assign you to relevant mailing lists.</li>
            </ul>
            <p>
            ...
            <p>
                ...
                This processing is carried out on the basis of Art. 6(1)(F) of the GDPR and in the interest of optimizing or enabling the use of and adapting the appearance of our website.
            </p>
            ...
            <ol>
                <li>
                    You can prevent cookies from being saved to your device using the respective setting in your browser software; 
                    we would like to explicitly state, however, that you may not be able to completely use all of this website&rsquo;s features if you deactivate cookies. 
                </li>
                
                <li>
                    Besides taking this step, you can prevent the data generated by the cookie related to your use of this website (including your IP address) from being sent to and processed by Google by downloading and installing the browser plug-in available here: (
                        <a href="https://tools.google.com/dlpage/gaoptout" rel="noreferrer noopener">https://tools.google.com/dlpage/gaoptout</a>
                    )
                </li>
            </ol>
