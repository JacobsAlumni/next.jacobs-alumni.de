...
export default class English extends React.Component {
    render() {
        return <Layout title="Privacy Policy (valid from 15th August 2020)" noCopy>
            ...
            <p>
                Please also see the Privacy Policy of Stripe Inc. (<a href="https://stripe.com/de/privacy">https://stripe.com/de/privacy</a>) to read more details on how they ensure that your personal information is treated confidentially.
            </p>
